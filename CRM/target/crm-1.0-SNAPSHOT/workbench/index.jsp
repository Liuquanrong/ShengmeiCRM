<%@ page import="com.quanrong.utils.MD5Util" %>
...
<script type="text/javascript">
	...
	$(function(){
        ...
        //点击确定退出模态窗口的时候自动返回登录页，销毁Session对象
        $("#confirmClose").click(function (){
            $("#exitModal").modal("hide");
            window.location.href="login.jsp";
            $.ajax({
                url:"user/confirmClose.do"
            })
        })
});
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="$('editPwdForm')[0].reset()">取消</button>
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        ...
        <!--用户点击确定退出操作以后，将当前的Session对象进行销毁，防止恶意登陆-->
        <button type="button" id="confirmClose" class="btn btn-primary" >确定</button>
    </div>
</div>
</div>
</div>
...
<ul>
    <li class="dropdown user-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="javascript:void(0)" id="editPwd"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
